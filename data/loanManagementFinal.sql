...
INSERT INTO `users` (`UserId`, `email`, `password`) VALUES
	(1, 'Farrah@lm.com', 'abcd1234'),
	(2, 'Malcolm@lm.com', 'abcd1234'),
	(3, 'Filippa@lm.com', 'abcd1234'),
	(4, 'Dido@lm.com', 'abcd1234'),
	(5, 'Annelise@lm.com', 'abcd1234'),
	(6, 'Herminia@lm.com', 'abcd1234'),
	(7, 'Lind@lm.com', 'abcd1234'),
	(8, 'Mimi@lm.com', 'abcd1234'),
	(9, 'Ileana@lm.com', 'abcd1234'),
	(10, 'Larissa@lm.com', 'abcd1234');
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  KEY `Customer_FK1` (`UserId`),
  CONSTRAINT `Customer_FK1` FOREIGN KEY (`UserId`) REFERENCES `users` (`UserId`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;

-- Dumping data for table loan_management.customer: ~10 rows (approximately)
/*!40000 ALTER TABLE `customer` DISABLE KEYS */;
INSERT INTO `customer` (`CustomerId`, `customer_name`, `customer_phone`, `customer_address`, `balance`, `UserId`) VALUES
	(1, 'Farrah Dobbie', '3688961901', '49862 Kingsford Junction', 69687.54, 1),
	(2, 'Malcolm Orbell', '8867727382', '385 Lawn Terrace', 55592.51, 2),
	(3, 'Filippa Bucknill', '6677805329', '1898 Michigan Road', 53826.01, 3),
	(4, 'Dido Vanezis', '2887691797', '57689 Myrtle Park', 30581.83, 4),
	(5, 'Annelise Aspland', '2096293966', '3922 Cherokee Place', 87026.91, 5),
	(6, 'Herminia Newby', '8111478402', '19 Chive Center', 5414.47, 6),
	(7, 'Lind Hanley', '7504959822', '7534 Village Green Center', 25921.26, 7),
	(8, 'Mimi Gilhooley', '6594140488', '16033 Pond Avenue', 62834.94, 8),
	(9, 'Ileana Parkes', '1281389203', '095 Warner Hill', 76939.31, 9),
	(10, 'Larissa Yeldham', '2812360584', '220 Shopko Parkway', 15790.59, 10);
